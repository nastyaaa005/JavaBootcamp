...
public class MyCalculatorTest extends TestCase {
	...
	public void testGetSumPositiveNumbers(){
		int a = 5;
		int b = 10;
	...
	public void testGetSumWithOneNegativeNumber(){
		int a = -5;
		int b = 10;
	...
	public void testGetSumTwoNegativeNumbers(){
		int a = -5;
		int b = -10;
		//	Checks the sum of two (2) negative values
		assertEquals(-15, (theCalculator.getSum(a,b)));
		assertEquals(-15, (theCalculator.getSum(b,a)));
		//assertEquals("Bad  result", -15, (theCalculator.getSum(a, b)));
		//assertFalse("Bad result", -14 != (theCalculator.getSum(a, b)));
	}


	public void testGetDifferencePositiveNumbers() {
	...
	public void testGetDifferenceOneNegativeNumbers() {
	...
	public void testGetDifferenceNegativeNumbers(){
